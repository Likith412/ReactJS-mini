...
class VisitCountries extends Component {
  ...
  renderNoVisitedCountriesView = () => (
    <div className="no-visited-countries-view-container">
      <p className="no-visited-countries-view-text">
        No Countries Visited Yet!
      </p>
    </div>
  )

  renderVisitedCountriesView = () => {
          ...
          if (eachItem.isVisited) {
            return (
              <VisitedCountryItem
                ...
                key={eachItem.id}
                markAsUnvisited={this.markAsUnvisited}
              />
            )
          }
          return null
    ...
    return (
      <div className="bg-container">
        <div className="container">
          ...
          {countriesList.filter(eachItem => eachItem.isVisited).length === 0
            ? this.renderNoVisitedCountriesView()
            : this.renderVisitedCountriesView()}
        </div>
      </div>
    )
  }
